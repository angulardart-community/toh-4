...
class _ViewHeroDetailComponent1 extends AppView<import1.HeroDetailComponent> {
  ...
  import11.DefaultValueAccessor _DefaultValueAccessor_10_4;
  List<dynamic> _NgValueAccessor_10_5;
  import12.NgModel _NgModel_10_6;
  var _expr_0;
  var _expr_1;
  ...
  ComponentRef<import1.HeroDetailComponent> build() {
    ...
    _DefaultValueAccessor_10_4 = new import11.DefaultValueAccessor(_el_10);
    _NgValueAccessor_10_5 = [_DefaultValueAccessor_10_4];
    _NgModel_10_6 = new import12.NgModel(null, _NgValueAccessor_10_5);
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, const import13.OpaqueToken<import14.ControlValueAccessor<dynamic>>('NgValueAccessor')) && (10 == nodeIndex))) {
      return _NgValueAccessor_10_5;
    }
    if (((identical(token, import12.NgModel) || identical(token, import15.NgControl)) && (10 == nodeIndex))) {
  ...
  void detectChangesInternal() {
    ...
    final currVal_0 = import8.interpolate1('', _ctx.hero.name, ' details!');
