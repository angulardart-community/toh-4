...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Primitives_functionNoSuchMethod_closure: {
      "^": "Closure:61;_box_0,$arguments,namedArgumentList",
    ...
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 5, 0, 2, 5],
    ...
    _rootErrorCallback: [function($self, $parent, zone, error, stackTrace) {
      H.interceptedTypeCheck(stackTrace, "$isStackTrace");
      return;
    }, "call$5", "async___rootErrorCallback$closure", 10, 0, 11],
    ...
    }, "call$4", "async___rootScheduleMicrotask$closure", 8, 0, 7],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 5, 0, 2, 5],
    ...
    DefaultIterableDiffer: {
      ...
      check$1: function(_, collection) {
        var record, t1, t2, t3, t4, t5, index, item, itemTrackBy, t6;
        this._reset$0();
        record = this._itHead;
        t1 = J.getInterceptor$asx(collection);
        this._default_iterable_differ$_length = t1.get$length(collection);
        for (t2 = this._trackByFn, t3 = record, t4 = false, t5 = 0; C.JSInt_methods.$lt(t5, this._default_iterable_differ$_length); index = t5 + 1, t5 = index, t3 = record) {
          item = t1.$index(collection, t5);
          ...
          record = t3._default_iterable_differ$_next;
        }
        t1 = t3;
        this._truncate$1(t1);
    ...
    NgZone: {
      ...
      }, "call$4", "get$_scheduleMicrotask", 8, 0, 7],
    ...
    PublicTestability: {
      ...
      }, "findBindings$2", "call$3", "call$1", "call$2", "get$findBindings", 2, 4, 40, 0, 0, 20, 53, 54],
    ...
    initReflector7: function() {
      if ($._visited9)
        return;
      $._visited9 = true;
      $.$get$_factories().$indexSet(0, C.Type_RadioControlRegistry_0, new F.initReflector_closure1());
      R.initReflector12();
      G.initReflector13();
      E.initReflector0();
    },
    ...
    initReflector8: function() {
      if ($._visited8)
        return;
      $._visited8 = true;
      $.$get$_factories().$indexSet(0, C.Type_FormBuilder_U44, new G.initReflector_closure0());
      L.initReflector11();
      O.initReflector9();
      E.initReflector0();
    },
    ...
    AppComponent: {
      ...
      set$heroes: function(heroes) {
        this.heroes = H.assertSubtype(heroes, "$isList", [G.Hero], "$asList");
      },
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$goto = 2;
                return P._asyncAwait($async$self._heroService.getHeroes$0(), $async$getHeroes$0);
              case 2:
                // returning from await.
                $async$temp1.set$heroes($async$result);
                // implicit return
    ...
    }, "call$2", "app_component_template__viewFactory_AppComponent1$closure", 4, 0, 60],
    viewFactory_AppComponentHost0: [function(parentView, parentIndex) {
      var t1 = new V._ViewAppComponentHost0(null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
    ...
    ViewAppComponent0: {
      "^": "AppView;_app_component_template$_el_0,_text_1,_el_2,_app_component_template$_el_4,_appEl_5,_NgFor_5_7,_el_6,_compView_6,_HeroDetailComponent_6_4,_app_component_template$_expr_1,_expr_2,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var parentRenderNode, doc, t1, _text_3, _anchor_5, t2;
        ...
        this._app_component_template$_el_4 = t1;
        t1.className = "heroes";
        this.addShimC$1(t1);
        t1 = $.$get$ngAnchor();
        _anchor_5 = (t1 && C.Comment_methods).clone$1(t1, false);
        t1 = this._app_component_template$_el_4;
        (t1 && C.UListElement_methods).append$1(t1, _anchor_5);
        t1 = new V.ViewContainer(5, 4, this, _anchor_5, null, null, null);
        this._appEl_5 = t1;
        this._NgFor_5_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, H.interceptedTypeCheck(V.app_component_template__viewFactory_AppComponent1$closure(), "$isFunction")));
        t1 = M.ViewHeroDetailComponent0$(this, 6);
        this._compView_6 = t1;
        t1 = t1.rootEl;
        this._el_6 = t1;
        ...
        this._HeroDetailComponent_6_4 = t1;
        t2 = this._compView_6;
        t2.toString;
      ...
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroDetailComponent_e4a && 6 === nodeIndex)
          return this._HeroDetailComponent_6_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, t1, currVal_1, t2, t3, changes, collection, currVal_2;
        _ctx = H.interceptedTypeCheck(this.ctx, "$isAppComponent");
        t1 = this.viewData._cdState;
        currVal_1 = _ctx.heroes;
        t2 = this._app_component_template$_expr_1;
        if (t2 == null ? currVal_1 != null : t2 !== currVal_1) {
          ...
          if (t2._differ == null && currVal_1 != null) {
            t2._ngForTrackBy;
        ...
        currVal_2 = _ctx.selectedHero;
        t2 = this._expr_2;
        if (t2 == null ? currVal_2 != null : t2 !== currVal_2) {
          this._HeroDetailComponent_6_4.hero = currVal_2;
    ...
    _ViewAppComponent1: {
      "^": "AppView;_app_component_template$_el_0,_app_component_template$_el_1,_app_component_template$_text_2,_text_4,_app_component_template$_expr_0,_app_component_template$_expr_1,_expr_2,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        ...
        this._app_component_template$_el_0 = t1;
        this.addShimE$1(t1);
        t1 = S.createSpanAndAppend(doc, this._app_component_template$_el_0);
        this._app_component_template$_el_1 = t1;
        t1.className = "badge";
        this.addShimE$1(t1);
        t1 = doc.createTextNode("");
        this._app_component_template$_text_2 = t1;
        t2 = this._app_component_template$_el_1;
        (t2 && C.SpanElement_methods).append$1(t2, t1);
        _text_3 = doc.createTextNode(" ");
        J.append$1$x(this._app_component_template$_el_0, _text_3);
        t1 = doc.createTextNode("");
        this._text_4 = t1;
        J.append$1$x(this._app_component_template$_el_0, t1);
        t1 = this._app_component_template$_el_0;
      ...
      detectChangesInternal$0: function() {
        ...
        if (this._app_component_template$_expr_0 !== currVal_0) {
          t1 = H.interceptedTypeCheck(this._app_component_template$_el_0, "$isHtmlElement");
          if (currVal_0)
        ...
        if (this._app_component_template$_expr_1 !== currVal_1) {
          this._app_component_template$_text_2.textContent = currVal_1;
          this._app_component_template$_expr_1 = currVal_1;
        }
      ...
      _handle_click_0_0$1: [function($$event) {
        ...
        this.ctx.onSelect$1(0, local_hero);
    ...
    _ViewAppComponentHost0: {
      "^": "AppView;_compView_0,_HeroService_0_4,_AppComponent_0_5,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3, t4;
        t1 = new V.ViewAppComponent0(null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), this, null, null, null);
        ...
        t2 = new M.HeroService();
        this._HeroService_0_4 = t2;
        t2 = new Q.AppComponent("Tour of Heroes", t2, null, null);
      ...
      detectChangesInternal$0: function() {
        if (this.viewData._cdState === 0)
          this._AppComponent_0_5.getHeroes$0();
    ...
    viewFactory_HeroDetailComponent1: [function(parentView, parentIndex) {
      var t1 = new M._ViewHeroDetailComponent1(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex, null));
      t1.componentType = $.ViewHeroDetailComponent0__renderType;
      return H.assertSubtype(t1, "$isAppView", [U.HeroDetailComponent], "$asAppView");
    }, "call$2", "hero_detail_component_template__viewFactory_HeroDetailComponent1$closure", 4, 0, 41],
    viewFactory_HeroDetailComponentHost0: [function(parentView, parentIndex) {
      var t1 = new M._ViewHeroDetailComponentHost0(null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex, null));
      return t1;
    }, "call$2", "hero_detail_component_template__viewFactory_HeroDetailComponentHost0$closure", 4, 0, 12],
    ...
    ViewHeroDetailComponent0: {
      ...
      build$0: function() {
        ...
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        t1 = $.$get$ngAnchor();
        _anchor_0 = (t1 && C.Comment_methods).clone$1(t1, false);
        J.append$1$x(parentRenderNode, _anchor_0);
        t1 = new V.ViewContainer(0, null, this, _anchor_0, null, null, null);
        this._appEl_0 = t1;
        this._NgIf_0_7 = new K.NgIf(new D.TemplateRef(t1, H.interceptedTypeCheck(M.hero_detail_component_template__viewFactory_HeroDetailComponent1$closure(), "$isFunction")), t1, false);
        this.init$2(C.List_empty0, null);
        return;
      },
      detectChangesInternal$0: function() {
        var _ctx = H.interceptedTypeCheck(this.ctx, "$isHeroDetailComponent");
        this._NgIf_0_7.set$ngIf(_ctx.hero != null);
      ...
      static: {
        ViewHeroDetailComponent0$: function(parentView, parentIndex) {
          var t1 = new M.ViewHeroDetailComponent0(null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
    ...
    _ViewHeroDetailComponent1: {
      ...
      build$0: function() {
        var doc, t1, t2, _text_3, t3, subscription_0;
        doc = document;
        t1 = doc.createElement("div");
        H.interceptedTypeCheck(t1, "$isDivElement");
        this._el_0 = t1;
        t1 = S.createAndAppend(doc, "h2", t1);
        this._el_1 = t1;
        ...
        t2 = S.createDivAndAppend(doc, this._el_0);
        this._el_4 = t2;
        t2 = S.createAndAppend(doc, "label", t2);
        this._el_5 = t2;
        J.append$1$x(t2, doc.createTextNode("id:"));
        t2 = doc.createTextNode("");
        this._text_7 = t2;
        t1 = this._el_4;
        (t1 && C.DivElement_methods).append$1(t1, t2);
        t2 = S.createDivAndAppend(doc, this._el_0);
        this._el_8 = t2;
        t2 = S.createAndAppend(doc, "label", t2);
        this._el_9 = t2;
        J.append$1$x(t2, doc.createTextNode("name:"));
        t2 = H.interceptedTypeCheck(S.createAndAppend(doc, "input", this._el_8), "$isInputElement");
        this._el_11 = t2;
        (t2 && C.InputElement_methods).setAttribute$2(t2, "placeholder", "name");
        t2 = new O.DefaultValueAccessor(this._el_11, H.functionTypeCheck(new O.closure8(), {func: 1, v: true, args: [,]}), H.functionTypeCheck(new O.closure9(), {func: 1, v: true}));
        this._DefaultValueAccessor_11_4 = t2;
        t2 = [t2];
        this._NgValueAccessor_11_5 = t2;
        H.assertSubtype(t2, "$isList", [L.ControlValueAccessor], "$asList");
        t1 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t1._init$1(t2);
        this._NgModel_11_6 = t1;
        t1 = this._el_11;
        t2 = this.eventHandler1$1(this.get$_handle_input_11_1());
        t1.toString;
        t3 = {func: 1, args: [W.Event]};
        H.functionTypeCheck(t2, t3);
        (t1 && C.InputElement_methods)._addEventListener$3(t1, "input", t2, null);
        t1 = this._el_11;
      ...
      detectChangesInternal$0: function() {
        ...
        _ctx = H.interceptedTypeCheck(this.ctx, "$isHeroDetailComponent");
        t1 = this.viewData._cdState;
        this._NgModel_11_6.set$model(_ctx.hero.name);
        ...
        currVal_0 = Q.interpolate0(_ctx.hero.name);
        if (this._expr_0 !== currVal_0) {
          this._text_2.textContent = currVal_0;
          this._expr_0 = currVal_0;
        }
        currVal_1 = Q.interpolate0(_ctx.hero.id);
      ...
      _handle_ngModelChange_11_0$1: [function($$event) {
        this.ctx.get$hero().name = H.stringTypeCheck($$event);
      }, "call$1", "get$_handle_ngModelChange_11_0", 2, 0, 6],
      ...
      }, "call$1", "get$_handle_input_11_1", 2, 0, 6],
      $asAppView: function() {
        return [U.HeroDetailComponent];
      }
    },
    _ViewHeroDetailComponentHost0: {
      ...
      build$0: function() {
        ...
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroDetailComponent_0_4, [U.HeroDetailComponent]);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
    ...
    StackZoneSpecification: {
      ...
      }, "call$5", "get$_stack_zone_specification$_errorCallback", 10, 0, 11],
  ...
  C.ComponentFactory_EeP = new D.ComponentFactory("hero-detail", M.hero_detail_component_template__viewFactory_HeroDetailComponentHost0$closure(), C.List_empty0, [U.HeroDetailComponent]);
...
;
  ...
  (function(lazies) {
    ...
    return H.assertSubtype([new G.Hero(11, "Mr. Nice"), new G.Hero(12, "Narco"), new G.Hero(13, "Bombasto"), new G.Hero(14, "Celeritas"), new G.Hero(15, "Magneta"), new G.Hero(16, "RubberMan"), new G.Hero(17, "Dynama"), new G.Hero(18, "Dr IQ"), new G.Hero(19, "Magma"), new G.Hero(20, "Tornado")], "$isList", [G.Hero], "$asList");
  ...
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [,]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, args: [P.int,,]}, {func: 1, args: [P.bool]}, {func: 1, args: [, P.StackTrace]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.String}, {func: 1, v: true, args: [P.Uint8List, P.String, P.int]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, v: true, args: [P.String, P.int]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, args: [P.String]}, {func: 1, v: true, args: [P.int, P.int]}, {func: 1, ret: P.int, args: [[P.List, P.int], P.int]}, {func: 1, args: [R.CollectionChangeRecord, P.int, P.int]}, {func: 1, ret: P.Future}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, args: [Y.NgZone]}, {func: 1, ret: P.Uint8List, args: [,,]}, {func: 1, v: true, args: [, U.Chain]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, ret: P.Object, args: [P.Type], named: {deps: [P.List, P.Object]}}, {func: 1, ret: P.Object, args: [P.Object]}, {func: 1, ret: P.Object, args: [P.Function], named: {deps: [P.List, P.Object]}}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, ret: P.bool}, {func: 1, v: true, args: [P.Function]}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}, {func: 1, ret: [S.AppView, U.HeroDetailComponent], args: [S.AppView, P.num]}, {func: 1, args: [W.Element, P.bool]}, {func: 1, args: [[P.List, N.EventManagerPlugin], Y.NgZone]}, {func: 1, args: [V.HammerGestureConfig]}, {func: 1, args: [,], named: {rawValue: P.String}}, {func: 1, args: [Z.AbstractControl]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [, P.String]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, ret: [S.AppView, Q.AppComponent], args: [S.AppView, P.num]}, {func: 1, args: [P.String,,]}, {func: 1, args: [W.Element], opt: [P.bool]}];
